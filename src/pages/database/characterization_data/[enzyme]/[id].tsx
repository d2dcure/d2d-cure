...
import { DownloadIcon, EyeIcon, ShareIcon, PrinterIcon, BugIcon, CalendarIcon, UserIcon, PercentIcon, SlidersHorizontalIcon, FileTextIcon } from 'lucide-react';
                ...
                <div className="space-y-3">
                  <div className="relative group">
                    ...
                    >
                      ...
                      <EyeIcon className="w-5 h-5 text-gray-400 group-hover:text-[#06B7DB] transition-colors duration-200 ml-2" />
                    </button>
                  </div>
                </div>
              )}
