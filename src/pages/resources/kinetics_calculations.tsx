		...
		<>
			...
			<div className="px-6 md:px-12 lg:px-24 py-16 bg-white">
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					In chemistry, a <strong>reaction rate</strong> is defined as a change in concentration (<i>c</i>) 
					over a change in time (<i>t</i>).
					Thus, rate can be defined mathematically as &Delta;<i>c</i>/&Delta;<i>t</i> for 
					a <em>range</em> of time or 
					&delta;<i>c</i>/&delta;<i>t</i> for an <em>instant</em> of time. 
			...
			<div className="px-6 md:px-12 lg:px-24 py-16 bg-white">
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					we need to have as close to an instanteous rate (&delta;<i>c</i><sub>P</sub>/&delta;<i>t</i>, 
					...
					because at the start of an enzyme reaction there should be so much substrate molecule 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					but it can be calculated from 
					the <strong>steepest slope</strong> of <strong>absorbance</strong> (<i>A</i>) of 
					light over time at the <em>beginning</em> of a reaction, 
					...
					420&nbsp;<abbr title="nanometers">nm</abbr> (the 
					frequency of light best absorbed by <abbr title="para-nitrophenol">PNP</abbr>) 
					...
					As an equation, the law 
					is <abbr title="absorbance"><i>A</i></abbr>&nbsp;=&nbsp;<abbr title="extinction coefficient">&epsilon;</abbr><i>l</i><i>c</i>,
					where <abbr title="extinction coefficient">&epsilon;</abbr> is the extinction coefficient 
					in <abbr title="inverse millimolar">mᴍ<sup>&minus;1</sup></abbr>&nbsp;<abbr title="inverse centimeters">cm<sup>&minus;1</sup></abbr>,
					<abbr title="length"><i>l</i></abbr> is the path length in <abbr title="centimeters">cm</abbr>,
					and <abbr title="concentration"><i>c</i></abbr> is the concentration in <abbr title="millimolar">mᴍ</abbr>.
					Rearranging the Beer–Lambert law and using bracket notation 
					([<abbr title="para-nitrophenol">PNP</abbr>]&nbsp;=&nbsp;
					...
					we can calculate the rate of <abbr title="para-nitrophenol">PNP</abbr> release from the steepest slope<sup><a href="#note1">note&nbsp;1</a></sup> as follows:
				</p>
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					and adjust for the pathlength of the light to obtain the initial velocity. 
					Since absorbance, being the logarithm of the <em>ratio</em> of light transmitted and light received, 
					has no units,<sup><a href="#note2">note&nbsp;2</a></sup> using 
			...
			<div className="px-6 md:px-12 lg:px-24 py-16 bg-white">
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					and that equation is called the <strong>Michaelis–Menten equation</strong>:
				</p>
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					<abbr title="maximum velocity"><i>v</i><sub>max</sub></abbr><sup><a href="#note3">note&nbsp;3</a></sup> in 
					the equation is <strong>maximum velocity</strong>.
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					that is, ten product molecules per enzyme molecule per second.) 
					It is also called a &ldquo;turnover number&rdquo;,
					because it gives the number of substrate molecules turned over into product by a single enzyme molecule in a given unit of 
					time. <abbr title="catalytic rate constant"><i>k</i><sub>cat</sub></abbr> is an indication of how good the enzyme is at performing the reaction,
					with bigger values corresponding to faster enzymes.
				</p>
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					More properly, <abbr title="catalytic rate constant"><i>k</i><sub>cat</sub></abbr> is 
					the <strong>rate constant</strong> of the chemical reaction 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					in this case, the enzyme&ndash;substrate (ES)) concentration. <em>If</em>, 
					however, the reaction is performed under saturating conditions&mdash;such as 
					at the beginning of a reaction&mdash;we have so much S 
					that we can safely assume that all of the enzyme is bound up with substrate to make ES.
					We assume that, at the beginning, [E]&nbsp;=&nbsp;[ES].
				</p>
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					Just like any other first-order rate constant in second-semester 
					chemistry, <abbr title="catalytic rate constant"><i>k</i><sub>cat</sub></abbr> can 
					be used in a <strong>rate law</strong> to give the rate of a reaction
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					The <em>maximum rate/velocity</em> (<abbr title="maximum velocity"><i>v</i><sub>max</sub></abbr>) 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					from <abbr title="maximum velocity"><i>v</i><sub>max</sub></abbr><sup><a href="#note3">note&nbsp;3</a></sup> by 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					the enzyme&rsquo;s <strong>specificity constant</strong>.
					...
					Enzymes with high <abbr title="catalytic rate constant"><i>k</i><sub>cat</sub></abbr>/<abbr title="Michaelis constant"><i>K</i><sub>M</sub></abbr> values 
					are efficient at what they do;
			...
			<div className="px-6 md:px-12 lg:px-24 py-16 bg-white">
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					Since molar concentration is moles per <em>volume</em>, 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					For example, if our total assay volume is
					100&nbsp;<abbr title="microliters">μL</abbr> and 
					we have a rate of 200&nbsp;<abbr title="millimolar per minute">mᴍ/min</abbr>:
				</p>
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					including <abbr title="observed rate constant"><i>k</i><sub>obs</sub></abbr>. <abbr title="observed rate constant"><i>k</i><sub>obs</sub></abbr> can 
					be calculated by multiplying the specific activity times the molar mass of the enzyme 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					...
					calculate <abbr title="observed rate constant"><i>k</i><sub>obs</sub></abbr> from <em>activities</em> (instead 
					of <em>specific</em> activities) in the following manner, 
				...
				<p className="mt-4 text-gray-600 dark:text-gray-300">
					Remember, to use <abbr title="observed rate constant"><i>k</i><sub>obs</sub></abbr> to 
					calculate the <abbr title="catalytic rate constant"><i>k</i><sub>cat</sub></abbr>,
					one would need to know the maxiumum 
					possible <abbr title="observed rate constant"><i>k</i><sub>obs</sub></abbr> for 
					that enzyme, which would be when that enzyme was fully saturated by substrate molecules. 
